                    ...
                    <tbody className="divide-y divide-border-default">
                        {Array.from({ length: 6 }).map((_, i) => (
                            <tr key={i}>
                                ...
                                <td className="px-6 py-4"><div className="h-4 w-10 bg-bg-tertiary rounded" /></td>
                                ...
                                <td className="px-6 py-4"><div className="h-4 w-20 bg-bg-tertiary rounded" /></td>
                                <td className="px-6 py-4"><div className="flex gap-2"><div className="w-7 h-7 bg-bg-tertiary rounded" /><div className="w-7 h-7 bg-bg-tertiary rounded" /><div className="w-7 h-7 bg-bg-tertiary rounded" /></div></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
